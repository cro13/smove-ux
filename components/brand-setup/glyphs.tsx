...
export function LinkedinGlyph({ className }: GlyphProps) {
	return (
		<svg
			...
			className={className}
		>
			<path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM0 8h5v16H0V8zm7.5 0H12v2.2h.07c.62-1.18 2.14-2.42 4.4-2.42 4.71 0 5.58 3.1 5.58 7.13V24h-5v-7.16c0-1.71-.03-3.91-2.38-3.91-2.39 0-2.75 1.87-2.75 3.79V24h-5V8z" />
		</svg>
	)
}
...
export function FacebookGlyph({ className }: GlyphProps) {
	return (
		<svg
			...
			className={className}
		>
			<path d="M24 12.07C24 5.41 18.63 0 12 0S0 5.41 0 12.07c0 6.02 4.39 11.01 10.13 11.93v-8.43H7.08v-3.5h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.97h-1.51c-1.49 0-1.95.93-1.95 1.89v2.26h3.32l-.53 3.5h-2.79V24C19.61 23.08 24 18.09 24 12.07z" />
		</svg>
	)
}
